namespace OrchestAI.AI.Abstractions;
public sealed record LLMRequest { public string Prompt { get; init; } = default!; public string? SystemPrompt { get; init; } public string Model { get; init; } = "default"; public double? Temperature { get; init; } public int? MaxTokens { get; init; } }
