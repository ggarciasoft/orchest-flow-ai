...
public sealed record NodePortResponse(string Key, string DisplayName, string Description, string Type, bool? Required, object? DefaultValue, IReadOnlyCollection<string>? AllowedValues, string? OptionsSource = null, IReadOnlyDictionary<string, string>? OptionDescriptions = null, bool IsSensitive = false);
