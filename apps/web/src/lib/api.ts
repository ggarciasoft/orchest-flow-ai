...
export interface NodePort { key: string; displayName: string; description: string; type: string; required?: boolean; defaultValue?: unknown; allowedValues?: string[]; optionsSource?: string; optionDescriptions?: Record<string, string>; isSensitive?: boolean; }
