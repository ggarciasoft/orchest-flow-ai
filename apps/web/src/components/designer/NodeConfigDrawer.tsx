...
interface Props { node: Node; catalog: NodeDescriptor[]; onClose: () => void; onConfigChange: (config: Record<string, unknown>) => void; }

export function NodeConfigDrawer({ node, catalog, onClose, onConfigChange }: Props) {
