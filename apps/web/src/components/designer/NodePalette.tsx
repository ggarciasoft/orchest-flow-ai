...
interface Props { catalog: NodeDescriptor[]; onAddNode: (d: NodeDescriptor) => void; }
const CATEGORY_ORDER = ['system', 'ai', 'documents', 'logic', 'human', 'integrations'];
        ...
        return (
          <div key={cat}>
            ...
            {open[cat] && nodes.map(n => (
              <button key={n.type} onClick={() => onAddNode(n)}
