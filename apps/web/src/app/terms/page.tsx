      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        ...
        <div className="prose prose-slate prose-sm max-w-none space-y-6 text-slate-700">
          <section>
            ...
            <p>By accessing or using OrchestAI, you agree to be bound by these Terms of Service. If you do not agree, please do not use the service.</p>
          </section>
          <section>
            <h2 className="text-base font-semibold text-slate-900 mb-2">2. Use of Service</h2>
            <p>You may use OrchestAI for lawful purposes only. You are responsible for all activity that occurs under your account.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>OrchestAI is provided &quot;as is&quot; without warranties of any kind. We are not liable for any indirect or consequential damages.</p>
          </section>
          <section>
