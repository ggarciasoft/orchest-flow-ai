...
import { CheckCircle, XCircle, Loader2, Eye, EyeOff, Mail, Cpu, Cloud, Server } from 'lucide-react';
    ...
    <div>
      ...
      <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-amber-900">Secret Vault</p>
            <p className="text-xs text-amber-700">Manage encrypted named secrets for use in workflow nodes</p>
          </div>
        </div>
        <Link href="/settings/secrets"
          className="text-sm font-medium text-amber-800 border border-amber-300 rounded-lg px-3 py-1.5 hover:bg-amber-100 transition-colors">
          Manage Secrets →
        </Link>
      </div>
